...
\verbdef{\verbtextf}{swap selection[n1] selection[n2]}
...
\color{ao} \verb?remove [object]? & Deletes an object (a (multi)particle label, a region, a
    histogram or a cut). Removing a region also removes its associations with cuts
    and histograms; those associated exclusively with this region are deleted.\\
