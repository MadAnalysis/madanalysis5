def selection_57():
    ...
    pad.hist(x=xData, bins=xBinning, weights=y58_Y_0_weights,\
    ...
    # Boundary of y-axis
    ymax=(y58_Y_0_weights).max()*1.1
    ymin=0 # linear scale
    #ymin=min([x for x in (y58_Y_0_weights) if x])/100. # log scale
    ...
    # Saving the image
    plt.savefig('../../HTML/MadAnalysis5job_0/selection_57.png')
    plt.savefig('../../PDF/MadAnalysis5job_0/selection_57.png')
    plt.savefig('../../DVI/MadAnalysis5job_0/selection_57.eps')
