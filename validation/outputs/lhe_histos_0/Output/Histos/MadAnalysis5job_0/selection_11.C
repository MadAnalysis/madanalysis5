void selection_11()
{
  ...
  // Creating a new TH1F
  TH1F* S12_PT_0 = new TH1F("S12_PT_0","S12_PT_0",50,0.0,1000.0);
  // Content
  S12_PT_0->SetBinContent(0,0.0); // underflow
  S12_PT_0->SetBinContent(1,1.158587);
  S12_PT_0->SetBinContent(2,2.657027);
  S12_PT_0->SetBinContent(3,1.869187);
  S12_PT_0->SetBinContent(4,1.004109);
  S12_PT_0->SetBinContent(5,0.5252262);
  S12_PT_0->SetBinContent(6,0.2471653);
  S12_PT_0->SetBinContent(7,0.1235826);
  S12_PT_0->SetBinContent(8,0.06179132);
  S12_PT_0->SetBinContent(9,0.04634349);
  S12_PT_0->SetBinContent(10,0.07723915);
  S12_PT_0->SetBinContent(11,0.0);
  S12_PT_0->SetBinContent(12,0.0);
  S12_PT_0->SetBinContent(13,0.0);
  S12_PT_0->SetBinContent(14,0.01544783);
  S12_PT_0->SetBinContent(15,0.01544783);
  S12_PT_0->SetBinContent(16,0.0);
  S12_PT_0->SetBinContent(17,0.01544783);
  ...
  S12_PT_0->SetBinContent(41,0.0);
  S12_PT_0->SetBinContent(42,0.0);
  S12_PT_0->SetBinContent(43,0.0);
  S12_PT_0->SetBinContent(44,0.0);
  S12_PT_0->SetBinContent(45,0.0);
  S12_PT_0->SetBinContent(46,0.0);
  S12_PT_0->SetBinContent(47,0.0);
  S12_PT_0->SetBinContent(48,0.0);
  S12_PT_0->SetBinContent(49,0.0);
  S12_PT_0->SetBinContent(50,0.0);
  S12_PT_0->SetBinContent(51,0.0); // overflow
  S12_PT_0->SetEntries(506);
  // Style
  ...
  stack->GetXaxis()->SetTitle("p_{T} [ e ] (GeV/c) ");
