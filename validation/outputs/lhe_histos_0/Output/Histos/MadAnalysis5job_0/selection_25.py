def selection_25():
    ...
    # Creating weights for histo: y26_Y_0
    ...
    pad.hist(x=xData, bins=xBinning, weights=y26_Y_0_weights,\
    ...
    # Boundary of y-axis
    ymax=(y26_Y_0_weights).max()*1.1
    ymin=0 # linear scale
    #ymin=min([x for x in (y26_Y_0_weights) if x])/100. # log scale
