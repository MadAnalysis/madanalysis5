def selection_46():
    ...
    # Creating weights for histo: y47_PHI_0
    y47_PHI_0_weights = numpy.array([0.2162696,0.2317174,0.2317174,0.2935088,0.2008218,0.3553001,0.185374,0.2317174,0.2317174,0.2935088,0.2626131,0.2471653,0.2935088,0.2317174,0.2162696,0.1390305,0.3089566,0.3707479,0.2780609,0.3089566,0.2008218,0.1544783,0.185374,0.2008218,0.2317174,0.2780609,0.2162696,0.185374,0.2162696,0.1699261,0.2780609,0.185374])
    ...
    pad.hist(x=xData, bins=xBinning, weights=y47_PHI_0_weights,\
    ...
    # Boundary of y-axis
    ymax=(y47_PHI_0_weights).max()*1.1
    ymin=0 # linear scale
    #ymin=min([x for x in (y47_PHI_0_weights) if x])/100. # log scale
