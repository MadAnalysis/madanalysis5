def selection_121():
    ...
    pad.hist(x=xData, bins=xBinning, weights=y122_Y_0_weights,\
    ...
    # Boundary of y-axis
    ymax=(y122_Y_0_weights).max()*1.1
    ymin=0 # linear scale
    #ymin=min([x for x in (y122_Y_0_weights) if x])/100. # log scale
    ...
    # Saving the image
    plt.savefig('../../HTML/MadAnalysis5job_0/selection_121.png')
    plt.savefig('../../PDF/MadAnalysis5job_0/selection_121.png')
    plt.savefig('../../DVI/MadAnalysis5job_0/selection_121.eps')
