...
sdMT_MET = dsMT_MET = ObservableBase.Clone(
    MT_MET,
    name="sdMT_MET",
    combination=CombinationType.DIFFSCALAR,
    tlatex="sdM_{T}",
    latex="$sdM_T$",
)
...
dDELTAR = dvDELTAR = vdDELTAR = ObservableBase.Clone(
    DELTAR,
    name="dDELTAR",
    combination=CombinationType.DIFFVECTOR,
    tlatex="d#DeltaR",
    latex="$d\Delta R$",
)
...
sABSETA = ObservableBase.Clone(
    ABSETA,
    name="sABSETA",
    combination=CombinationType.SUMSCALAR,
    tlatex="s|#eta|",
    latex="$s|\eta|$",
)
...
rD0APPROX = ObservableBase.Clone(
    D0APPROX,
    name="rD0APPROX",
    combination=CombinationType.RATIO,
    tlatex="rd_{0}^{approx.}",
...
XD = ObservableBase(
    ...
    plot_unitX_tlatex="mm",
    plot_unitX_latex="mm",
    code_parton="closest_approach().X()",
    code_hadron="closest_approach().X()",
    code_reco="closest_approach().X()",
    cut_event=True,
    cut_candidate=True,
    tlatex="x_{d}",
    latex="$x_d$",
...
YD = ObservableBase(
    ...
    plot_unitX_tlatex="mm",
    plot_unitX_latex="mm",
    code_parton="closest_approach().Y()",
    code_hadron="closest_approach().Y()",
    code_reco="closest_approach().Y()",
    cut_event=True,
    cut_candidate=True,
    tlatex="y_{d}",
    latex="$y_d$",
...
ZD = ObservableBase(
    ...
    plot_unitX_tlatex="mm",
    plot_unitX_latex="mm",
    code_parton="closest_approach().Z()",
    code_hadron="closest_approach().Z()",
    code_reco="closest_approach().Z()",
    cut_event=True,
    cut_candidate=True,
    tlatex="z_{d}",
    latex="$z_d$",
