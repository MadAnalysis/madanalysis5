...
class AnalyzerManager:
    ...
    def WriteSource(self):
        ...
        file.write('  double myWeight;\n')
        file.write('  if(Configuration().IsNoEventWeight()) myWeight=1.;\n')
        file.write('  else if(event.mc()->weight()!=0.) myWeight=event.mc()->weight();\n')
        file.write('  else\n')
        file.write('  {\n')
        file.write('    WARNING << "Found one event with a zero weight. Skipping..." << endmsg;\n')
