...
bool JetClusteringGridJet::Initialize(const std::map<std::string,std::string>& options)
{ 
...
/// Print parameters
void JetClusteringGridJet::PrintParam() 
{
...
std::string JetClusteringGridJet::GetName()
{
  return "Grid Jet";
}

std::string JetClusteringGridJet::GetParameters()
{
  std::stringstream str;
  str << "Ymax=" << Ymax_ 
